...
function random(){return Math.floor(20*Math.random()+1)}function showCat(){}$(document).ready(function(){$(".btn").click(function(){$("#root").append('<img width="100px" src="assets/'+random()+'.png " />')})});